...
color_and_position = [[colorWHITE, (20, 20)], [colorBLACK, (55, 20)], [colorBLUE, (90, 20)], [colorGRAY, (125, 20)], [colorYELLOW, (160, 20)], 
    [colorSOGREEN, (195, 20)], [colorPURPLE, (230, 20)], [colorRED, (265, 20)], [colorGREEN, (300, 20)]]
Colors = pg.sprite.Group()
for i in color_and_position:
    temp = pallete(i[0], i[1])
    Colors.add(temp)

#creating the sprite group of instruments for work panel
items = [['eraser.png', (495, 20)], ['pen.png', (530, 20)], ['empty_rect.png', (565, 20)], ['empty_circle.png', (600, 20)], ['square.png', (635, 20)],
...
while run:
    ...
    constant_elements() #constantly blits constant elements like color panel 
    clock.tick(60)
    pg.display.update()